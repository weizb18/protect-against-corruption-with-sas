...
cifar100 = CIFAR100("./data/cifar100/", transform=transforms.ToTensor(), download=False)    # download should keep False
device = "cuda:0"
...
subset_dataset.save_to_file("./sas_subset/cifar100gau-0.2-sas-indices.pkl")
