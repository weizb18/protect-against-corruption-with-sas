...
def main(rank: int, world_size: int, args):
    ...
    testloader = torch.utils.data.DataLoader(
        dataset = torchvision.datasets.CIFAR100(root='./data/cifar100-original', train=False, download=False, transform=transforms.Compose([transforms.ToTensor(), transforms.Normalize((0.5071, 0.4865, 0.4409), (0.2009, 0.1984, 0.2023))])),    #
        batch_size=args.batch_size, 
        shuffle=False, 
        num_workers=4,
        pin_memory=True,
